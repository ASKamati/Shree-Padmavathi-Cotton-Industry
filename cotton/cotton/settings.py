...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'askdasskamati@gmail.com'  # 🔁 replace with your email
EMAIL_HOST_PASSWORD = 'nxcc pdiq vpma xkeq'  # 🔁 use App Password (not your normal Gmail password)
